                        ...
                        <ul class="navbar-nav d-flex justify-content-left align-items-center py-1">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item text-primary" href="{{route('projects.o')}}"> Projects</a></li>
                                    <li><a class="dropdown-item text-primary" href="{{route('tasks.o')}}"> Tasks </a></li>
                                    <li><a class="dropdown-item text-primary" href="{{route('team.o')}}"> Team members </a></li>
